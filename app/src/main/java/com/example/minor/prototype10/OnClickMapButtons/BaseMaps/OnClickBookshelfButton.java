        ...
        imageButton4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new android.os.Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        mainText.setText("民法第155条:すべての市民は指定の公的機関で定期的に検査を行う。これは市民の健康維持と、潜伏しているアメルーン一族の捜索を目的としている。年齢に対する力量指数が187.7pm以下である場合には、アメルーン一族である可能性が疑われる。直ちに能力テストを行い、何らかの異能が見つかった場合は、これを処分する。");
                        imageButton8.setEnabled(true);
                        imageButton8Text.setText("本を閉じる");
                        OnClickBookshelfButton onClickBookshelfButton = new OnClickBookshelfButton();
                        imageButton8.setOnClickListener(onClickBookshelfButton);
